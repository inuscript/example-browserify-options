...
browserify -e ./src/entry1.js -u ./lib/exclusion.js | js-beautify -f - > build/exclude.js
browserify -e ./src/entry1.js -x ./lib/**/*.js | js-beautify -f - > build/external.js
browserify -e ./src/entry1.js -i ./lib/exclusion.js | js-beautify -f - > build/ignore.js
